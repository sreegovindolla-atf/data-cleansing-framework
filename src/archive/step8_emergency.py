...
SQL = """
SELECT *
FROM silver.step8_emergency_input;
"""
...
for key, g in df.groupby(group_cols, dropna=False):
    ...
    if len(g) == 1:
        rows_out.append({
            ...
            "EmergencyTitle": g.loc[0, "EmergencyTitle"],
            "EmergencyTitleAR": g.loc[0, "EmergencyTitleAR"]
        })
        continue
    ...
    for cluster in clusters:
        ...
        rows_out.append({
            ...
            "EmergencyTitle": pick_longest("EmergencyTitle"),
            "EmergencyTitleAR": pick_longest("EmergencyTitleAR"),
...
dtype_map = {
    ...
    "EmergencyTitle": NVARCHAR(None),
    "EmergencyTitleAR": NVARCHAR(None),
